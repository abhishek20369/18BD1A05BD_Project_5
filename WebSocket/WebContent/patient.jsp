...
<meta charset="ISO-8859-1">
	...
	<script>
		...
		function checkOxygen(){
			...
			if(o2>=90){
				alert("Enter correct oxygen levels.. below 90");
			}
		}
	</script>
...
<body>
	<div class="container">
		...
		<input class="form-control form-control-sm" type="text" onblur="checkOxygen()" name="vital" id="vital"  style="display:inline-block; width:300px;margin-top:25px;"">
		<br>
		...
		<br>
		<label>Enter Heartbeat rate :</label>
		...
		<input class="form-control form-control-sm" type="text" onblur="checkContact()" name="vital2" id="vital2"  style="display:inline-block; width:300px;margin-top:25px;"">
		<br>
	...
	<script>
		...
		function sendVitals()
		{
			websocket.send(vital.value+','+vital1.value+','+vital2.value+','+vital3.value);
			vital.value="";
			vital1.value="";
			vital2.value="";
			vital3.value="";
