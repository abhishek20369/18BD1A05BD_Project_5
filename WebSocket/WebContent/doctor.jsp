...
<body>
	...
	<script>	
		...
		function sendInstructions(username,message)
		{
			...
			{
				websocket.send(username+','+message+','+details[3]);	
			}
		}
	</script>
</body>
